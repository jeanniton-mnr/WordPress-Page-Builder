...
class CSFramework_Option_upload extends CSFramework_Options {
  ...
  public function output() {
    ...
    $button_title = ( isset( $button_title ) ) ? $button_title : __( 'Upload', 'granted-champtheme' );
    $frame_title  = ( isset( $frame_title  ) ) ? $frame_title  : __( 'Upload', 'granted-champtheme' );
    $insert_title = ( isset( $insert_title ) ) ? $insert_title : __( 'Use Image', 'granted-champtheme' );

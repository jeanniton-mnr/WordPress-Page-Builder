...
(function() {
  ...
  AbstractChosen = (function() {
    ...
    AbstractChosen.prototype.search_results_touchstart = function(evt) {
      ...
      return this.search_results_mougrantedver(evt);
    };

    AbstractChosen.prototype.search_results_touchmove = function(evt) {
      this.touch_started = false;
      return this.search_results_mougrantedut(evt);
    };
  ...
  Chosen = (function(_super) {
    ...
    Chosen.prototype.register_observers = function() {
      ...
      this.search_results.bind('mougrantedver.chosen', function(evt) {
        _this.search_results_mougrantedver(evt);
      });
      this.search_results.bind('mougrantedut.chosen', function(evt) {
        _this.search_results_mougrantedut(evt);
      });
    ...
    Chosen.prototype.search_results_mougrantedver = function(evt) {
      var target;
      target = $(evt.target).hasClass("active-result") ? $(evt.target) : $(evt.target).parents(".active-result").first();
      if (target) {
    ...
    Chosen.prototype.search_results_mougrantedut = function(evt) {

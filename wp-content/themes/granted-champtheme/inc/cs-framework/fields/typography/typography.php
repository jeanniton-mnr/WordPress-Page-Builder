...
class CSFramework_Option_typography extends CSFramework_Options {
  ...
  public function output() {
    ...
    if( is_object( $google_json ) ) {
      ...
      echo '<optgroup label="'. __( 'Web Safe Fonts', 'granted-champtheme' ) .'">';
      ...
      echo '<optgroup label="'. __( 'Google Fonts', 'granted-champtheme' ) .'">';
      ...
      echo __( 'Error! Can not load json file.', 'granted-champtheme' );
